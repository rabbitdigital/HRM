 ...
 * @method EmpEmergencyContact setEmpNumber()    Sets the current record's "emp_number" value
 * @method EmpEmergencyContact setSeqno()        Sets the current record's "seqno" value
 * @method EmpEmergencyContact setName()         Sets the current record's "name" value
 * @method EmpEmergencyContact setRelationship() Sets the current record's "relationship" value
 * @method EmpEmergencyContact setHomePhone()    Sets the current record's "home_phone" value
 * @method EmpEmergencyContact setMobilePhone()  Sets the current record's "mobile_phone" value
 * @method EmpEmergencyContact setOfficePhone()  Sets the current record's "office_phone" value
 * @method EmpEmergencyContact setEmployee()     Sets the current record's "Employee" value
 * 
 * @package    orangehrm
 * @subpackage model
...
abstract class BaseEmpEmergencyContact extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('city as city', 'integer', 11, array(
             'type' => 'integer',
             'default' => '',
             'length' => 11,
             ));
