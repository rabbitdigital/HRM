...
abstract class BaseEmployee extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('emp_fathersname as fathersname', 'string', 100, array(
             'type' => 'string',
             'default' => '',
             'notnull' => true,
             'length' => 100,
        ...
        $this->hasColumn('emp_pan_num as panNo', 'string', 20, array(
             'type' => 'string',
             'default' => '',
             'length' => 20,
             ));

        $this->hasColumn('emp_blood_group as bloodGroup', 'string', 8, array(
             'type' => 'string',
             'default' => '',
             'length' => 20,
             ));
