...
abstract class BaseEmployeeForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'fathersname'			  => new sfWidgetFormInputText(),	
      ...
      'panNo'                 => new sfWidgetFormInputText(),
      'bloodGroup'            => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'fathersname'           => new sfValidatorString(array('max_length' => 50, 'required' => true)),
      ...
      'panNo'                 => new sfValidatorString(array('max_length' => 20,  'required' => false)),
      'bloodGroup'            => new sfValidatorString(array('max_length' => 8,   'required' => false)),
