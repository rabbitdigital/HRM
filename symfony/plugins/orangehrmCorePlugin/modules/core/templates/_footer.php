...
<div id="divFooter" >
    <span id="spanCopyright">
        <a href="http://www.rabbitdigital.in" target="_blank">Rabbit Digital</a> 
        ver <?php echo $version; ?> &copy; Rabbit Digital. 2012 - <?php echo $copyrightYear; ?> All rights reserved.
    </span>
