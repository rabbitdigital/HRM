...
<style type="text/css">
    ...
    #pimleftmenu ul.pimleftmenu li a {
        ...
        text-decoration: none;
        background:#c6a0f1 none repeat scroll 0 0;
        border-color:#613c8d #613c8d #613c8d #613c8d;
        border-style:solid;
        border-width:1px;
        color:#613c8d;
        font-size: 11px;
    ...
    #pimleftmenu ul.pimleftmenu li a.expanded {
        background: #613c8d url(<?php echo public_path("../../themes/orange/icons/expanded.gif");?>) no-repeat center right;
    }

    #pimleftmenu ul.pimleftmenu li a.collapsed {
        background: #613c8d url(<?php echo public_path("../../themes/orange/icons/collapsed.gif");?>) no-repeat center right;
        border-bottom: 1px solid #c6a0f1;
    }
