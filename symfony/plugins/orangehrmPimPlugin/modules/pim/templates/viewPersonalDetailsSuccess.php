...
<script type="text/javascript">
    ...
    var lang_FathersnameRequired = "<?php echo __(ValidationMessages::REQUIRED); ?>";
                                            ...
                                            <td>
                                                <table width="100%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td valign="top"><?php echo $form['txtEmpFathersname']->render(array("class" => "formInputText", "maxlength" => 50)); ?><br class="clear" /></td>
                                                    </tr>
                                                    <tr>
                                                        <td>&nbsp;</td>
                                                        <td class="helpText"><?php echo __("Father's Full Name"); ?><span class="required">*</span></td>
                                                    </tr>
                                            ...
                                            <td>
                                                ...
                                                <table border="0" width="100%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $form['txtpanNo']->render(array("class" => "formInputText", "maxlength" => 20)); ?></td>
                                                        <td><?php echo __('Blood Group'); ?></td>
                                                        <td><?php echo $form['txtbloodGroup']->render(array('class'=>'formInputText')); ?>
                                                            <br class="clear" />
                                                        </td>
                                                    </tr>
