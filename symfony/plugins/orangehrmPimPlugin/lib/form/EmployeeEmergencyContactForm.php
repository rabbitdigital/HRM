...
class EmployeeEmergencyContactForm extends BaseForm {
    ...
    public function configure() {
        ...
        $this->setWidgets(array(
            ...
            'city' => new sfWidgetFormSelect(array('choices' => $cities))
    ...
    public function save() {
        ...
        $emergencyContact->city = $this->getValue('city');
    ...
    private function getCityList() {
        ...
        $cities = $this->getCityService()->getCityList();
        foreach($cities as $city) {
            $list[$city->id] = $city->cou_name;
        }
        return $list;
    }    
    
    /**
     * Returns City Service
     * @returns CityService
     */
    public function getCityService() {
        if(is_null($this->cityService)) {
