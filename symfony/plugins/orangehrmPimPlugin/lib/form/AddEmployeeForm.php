...
class AddEmployeeForm extends sfForm {
    ...
    public function configure() {
        ...
        $this->widgets = array(
            ...
            'employeeId' => new sfWidgetFormInputText(array(), array("class" => "formInputText", "maxlength" => 10, "colspan" => 1)),
            'empWorkEmail' => new sfWidgetFormInputText(array(), array("class" => "formInputText", "maxlength" => 60, "colspan" => 1)),
...
//            'helpText' => new ohrmWidgetDiv(),
        ...
        $this->setValidators(array(
            ...
            'empWorkEmail' => new sfValidatorString(array('required' => true, 'max_length' => 60)),
    ...
    protected function getFormLabels() {
        $labels = array(
            ...
            'empWorkEmail' => __('Employee Email'),
...
//        print_r($file);die;
        ...
        $employee->emp_work_email = $posts['empWorkEmail'];
