...
class EmployeePersonalDetailsForm extends BaseForm {
    ...
    public function configure() {
        ...
        $this->widgets = array(
            ...
            'txtEmpFathersname' => new sfWidgetFormInputText(),
		...
		$this->widgets['txtEmpFathersname']->setAttribute('value', $employee->fathersname);
        ...
        // Widgets for non-ess mode only
            ...
            $this->widgets['txtpanNo'] = new sfWidgetFormInputText();
            $this->widgets['txtpanNo']->setAttribute('value', $employee->panNo);

            $this->widgets['txtbloodGroup'] = new sfWidgetFormInputText();
            $this->widgets['txtbloodGroup']->setAttribute('value', $employee->bloodGroup);
        ...
        $this->setValidators(array(
            ...
            'txtEmpFathersname' => new sfValidatorString(array('required' => true, 'trim' => true)),
            'txtpanNo' => new sfValidatorString(array('required' => false, 'trim' => true)),
            'txtbloodGroup' => new sfValidatorString(array('required' => false, 'trim' => true)),
    ...
    public function getEmployee() {
        ...
        $employee->fathersname = $this->getValue('txtEmpFathersname');
        $employee->panNo = $this->getValue('txtpanNo');
        $employee->bloodGroup = $this->getValue('txtbloodGroup');
