$(document).ready(function() {
    ...
    $("#frmEmpPersonalDetails").validate({
        rules: {
            ...
            'personal[txtEmpFathersname]': {required: true },            
        ...
        messages: {
            ...
            'personal[txtEmpFathersname]': { required: lang_FathersnameRequired },            
    ...
    $("#btnSave").click(function() {
        ...
        if($("#btnSave").attr('value') == edit) {
            ...
            if(readonlyFlag) {
                ...
                $("#personal_txtpanNo").attr('disabled', 'disabled');
                $("#personal_txtbloodGroup").attr('disabled', 'disabled');
